...
class LeftBookmark extends StatefulWidget {
  List<int> left;
  LeftBookmark({required this.left});

  @override
  _LeftBookmarkState createState() => _LeftBookmarkState();
}

class _LeftBookmarkState extends State<LeftBookmark> {
  @override
  void initState() {
            ...
            child: SingleChildScrollView(
              ...
              child: Container(
                ...
                child: Row(
                  ...
                  children: [
                    Container(height: 70,width: 70,child: ClipOval(child: data[widget.left[i]]["image"]),),
...
SizedBox(width: 10,),
                    Column(
                      ...
                      children: [
                        SizedBox(height: 5,),
                        data[widget.left[i]]["text"],
                        FlatButton(
                          color: Colors.teal[800],
                          onPressed: () async {
// l.remove("Aditi Deshmukh");
                            widget.left.remove(widget.left[i]);
                            print(widget.left);
                            Navigator.of(context).pop();
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => LeftBookmark(left:widget.left),
                              ),
                            );
